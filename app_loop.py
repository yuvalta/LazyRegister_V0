...
def go_to_course_signin(signin_url, web_driver, wanted_course_name):
    ...
    while 1:
        ...
        try:
            ...
            element_name = "aaaa.ModuleBasketView.Choose.1";
            elem1 = WebDriverWait(web_driver, 180).until(
            ...
            element_name = "aaaa.EventPackageSelectionView.packageTable:2.1"
            elem1 = WebDriverWait(web_driver, 180).until(
                EC.element_to_be_clickable((By.ID, element_name)))
            elem1.click()
            ...
            while 1:
                ...
                backButton = WebDriverWait(web_driver, 180).until(
                    EC.visibility_of_element_located((By.ID, "aaaa.EventsView.BackButton")))
                backButton.click()
                ...
                elem1 = WebDriverWait(web_driver, 180).until(
                    EC.visibility_of_element_located((By.ID, "aaaa.ModuleBasketView.NextButton")))
                elem1.click()
                ...
                savePlaceButton1 = WebDriverWait(web_driver, 180).until(
                    EC.visibility_of_element_located((By.ID, "aaaa.EventPackageSelectionView.bookingButton")))

                savePlaceButton1.click()
